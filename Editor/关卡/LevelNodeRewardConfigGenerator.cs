...
namespace MiGame.Level.Editor
{
    ...
    public class LevelNodeRewardConfigGenerator : EditorWindow
    {
        ...
        {
            3000, 10000, 30000, 40000, 60000, 80000, 110000, 140000, 170000,
            220000, 300000, 330000, 380000, 440000, 500000, 640000, 700000, 800000, 1000000
        };

        [MenuItem("Tools/关卡配置/批量生成关卡节点奖励配置")]
        public static void ShowWindow()
        {
            GetWindow<LevelNodeRewardConfigGenerator>("关卡奖励配置生成器");
        }
